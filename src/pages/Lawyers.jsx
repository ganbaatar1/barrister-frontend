...
import useDecodedTexts from "../utils/useDecodedText"; // ✅ Custom hook ашиглаж байна
...
function Lawyers() {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => setRawLawyers(res.data || []))
      .catch((err) => console.error("❌ Хуульчид татахад алдаа:", err));
  }, []);

  const lawyers = useDecodedTexts(rawLawyers); // ✅ Автомат decode
